# calcValidVegfruitShare

calculates the validation data for the share of vegetables, fruit and
nuts products (including fish) in total calorie food supply

## Usage

``` r
calcValidVegfruitShare(datasource = "FAO")
```
