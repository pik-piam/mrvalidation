...
#' @description calculates the validation data for the utilization of agricultural products for food, feed, bioenergy, seed, material, processing, or waste
#' 
...
calcValidDemand<-function(datasource="FAO", detail=T, nutrient="dm"){
  ...
  if(datasource=="FAO"){
    ...
    # for cereals, flour, brans and branoil are counted as fooduse, even though later being processed (FAO method)
    ...
    balanceflow<-  mb[,,"domestic_supply"]-dimSums(mb2[,,],dim=c(3.2))
