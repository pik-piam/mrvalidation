...
fullVALIDATION <- function(rev=0.1) {
  ...
  calcOutput(type="ValidWaterUsage",datasource="cwatm_ipsl-cm5a-lr", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="cwatm_gfdl-esm2m", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="cwatm_miroc5", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="cwatm_hadgem2-es", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="h08_ipsl-cm5a-lr", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="h08_gfdl-esm2m", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="h08_miroc5", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="h08_hadgem2-es", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="lpjml_ipsl-cm5a-lr", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="lpjml_gfdl-esm2m", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="lpjml_miroc5", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="lpjml_hadgem2-es", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="matsiro_ipsl-cm5a-lr", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="matsiro_gfdl-esm2m", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="matsiro_miroc5", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="matsiro_hadgem2-es", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="mpi-hm_ipsl-cm5a-lr", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="mpi-hm_gfdl-esm2m", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="mpi-hm_miroc5", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="pcr-globwb_ipsl-cm5a-lr", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="pcr-globwb_gfdl-esm2m", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="pcr-globwb_miroc5", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
  calcOutput(type="ValidWaterUsage",datasource="pcr-globwb_hadgem2-es", aggregate = FALSE, file="validation.mif", append = TRUE, try=TRUE)
