...
#' @description calculates the validation data for the share of inputs that go into processing processes, and the share of inputs that secondary products are composed of
...
#' @param indicator if "primary_to_process", returns the amount of primary product into processing. if "secondary_from_primary", gives primary into secondary. 
...
calcValidProcessing<-function(datasource="FAO", detail=T, nutrient="dm", indicator="secondary_from_primary"){
