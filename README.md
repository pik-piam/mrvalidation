...
R package **mrvalidation**, version **2.8.3**
...
Bacca E, Kreidenweis U, W. Yalew A, Humpenoeder F, Wang X, Dietrich J (2021). _mrvalidation: madrat data
preparation for validation purposes_. doi: 10.5281/zenodo.4317826 (URL:
https://doi.org/10.5281/zenodo.4317826), R package version 2.8.3, <URL:
