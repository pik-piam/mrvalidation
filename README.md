...
R package **mrvalidation**, version **2.37.15**
...
Bodirsky B, Wirth S, Karstens K, Humpenoeder F, Stevanovic M, Mishra A, Biewald A, Weindl I, Beier F, Chen D, Crawford M, Molina Bacca E, Kreidenweis U, W. Yalew A, Humpenoeder F, von Jeetze P, Wang X, Dietrich J, Alves M (2022). _mrvalidation: madrat data preparation for validation purposes_. doi: 10.5281/zenodo.4317826 (URL: https://doi.org/10.5281/zenodo.4317826), R package version 2.37.15, <URL: https://github.com/pik-piam/mrvalidation>.
...
@Manual{,
  ...
  year = {2022},
  note = {R package version 2.37.15},
