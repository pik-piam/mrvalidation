...
R package **mrvalidation**, version **2.2.0**
...
D, Molina Bacca E, Kreidenweis U, W. Yalew A, Humpenoeder F, Wang X, Dietrich J (2020).
_mrvalidation: madrat data preparation for validation purposes_. R package version 2.2.0.
